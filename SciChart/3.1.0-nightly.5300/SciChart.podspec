Pod::Spec.new do |spec|  
    spec.name = "SciChart"
    spec.version = "3.1.0-nightly.5300"
    ...
    spec.platform = :ios
    spec.source = { :http => "https://github.com/ABTSoftware/PodSpecs-Nightly/releases/download/#{spec.version}/SciChart_iOS_#{spec.version}.zip" }
